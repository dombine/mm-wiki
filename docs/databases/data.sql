...
INSERT INTO mw_privilege (privilege_id, name, parent_id, type, controller, action, icon, target, is_display, sequence, create_time, update_time) VALUES (78, '联系人', 71, 'controller', 'contact', 'list', 'glyphicon-list', '', 1, 101, unix_timestamp(now()), unix_timestamp(now()));
INSERT INTO mw_privilege (privilege_id, name, parent_id, type, controller, action, icon, target, is_display, sequence, create_time, update_time) VALUES (79, '添加联系人', 71, 'controller', 'contact', 'add', 'glyphicon-list', '', 0, 102, unix_timestamp(now()), unix_timestamp(now()));
INSERT INTO mw_privilege (privilege_id, name, parent_id, type, controller, action, icon, target, is_display, sequence, create_time, update_time) VALUES (80, '添加联系人保存', 71, 'controller', 'contact', 'save', 'glyphicon-list', '', 0, 103, unix_timestamp(now()), unix_timestamp(now()));
INSERT INTO mw_privilege (privilege_id, name, parent_id, type, controller, action, icon, target, is_display, sequence, create_time, update_time) VALUES (81, '修改联系人', 71, 'controller', 'contact', 'edit', 'glyphicon-list', '', 0, 104, unix_timestamp(now()), unix_timestamp(now()));
INSERT INTO mw_privilege (privilege_id, name, parent_id, type, controller, action, icon, target, is_display, sequence, create_time, update_time) VALUES (82, '修改联系人保存', 71, 'controller', 'contact', 'modify', 'glyphicon-list', '', 0, 105, unix_timestamp(now()), unix_timestamp(now()));
INSERT INTO mw_privilege (privilege_id, name, parent_id, type, controller, action, icon, target, is_display, sequence, create_time, update_time) VALUES (83, '删除联系人', 71, 'controller', 'contact', 'delete', 'glyphicon-list', '', 0, 106, unix_timestamp(now()), unix_timestamp(now()));
